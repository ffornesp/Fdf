...
int	draw_screen(t_map *map, t_vars *vars, t_data *data)
{
	...
	line_renderer(&map->points[18], &map->points[207], data, scale);
	// BOTTOM LEFT
	...
	line_renderer(&map->points[190], &map->points[37], data, scale);
	line_renderer(&map->points[190], &map->points[56], data, scale);
	line_renderer(&map->points[190], &map->points[75], data, scale);
	line_renderer(&map->points[190], &map->points[94], data, scale);
	line_renderer(&map->points[190], &map->points[113], data, scale);
	line_renderer(&map->points[190], &map->points[132], data, scale);
	line_renderer(&map->points[190], &map->points[151], data, scale);
	line_renderer(&map->points[190], &map->points[170], data, scale);
	line_renderer(&map->points[190], &map->points[189], data, scale);
	// BOTTOM RIGHT
